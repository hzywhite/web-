	...
	if(signVerified) {//验证成功
		...
		if(trade_status.equals("TRADE_FINISHED")){
			...
			String[] str=out_trade_no.split("_");
	  		...
	  		String wefly_Phone = phone;
	  		System.out.println("phone: "+phone+"flightno: "+flightno+"seatno: "+seatno);
			
	  		int flag = DBconn.addUpdDel("update reservations set status = 'paid' where status = 'unpaid' and phone ='"+phone+"' and flightno = '"+flightno+"' and seatno = '"+seatno+"'");
		...
		out.println("notify:success");
		
		
		
		
	}else {//验证失败
		out.println("notify:fail");
