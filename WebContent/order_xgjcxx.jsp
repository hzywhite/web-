...
<head>
	...
	function upd(url){
		...
		var IDNUM = document.getElementById("IDNum1");
	if(confirm("确定要更改信息？")){
		
	window.location.href = "update.jsp?phone="+url+"&name="+NAME.value+"&IDNum="+IDNUM.value;
	}
	
	document.form1.action("update.jsp?phone="+url+"&name="+NAME.value+"&IDNum="+IDNUM.value);
	}
	</script>
</head>
									...
									<div class="x2">
										...
										<div class="kuang_2">
											<div class="kuang_2_content">
												<input type="text" id="name1" value="<%=name %>" style="font-size:25px;">
											</div>
											<div class="kuang_2_content">
												<input type="text" id="IDNum1" value="<%=IDNum %>" style="font-size:25px;">
											</div>
											<div class="kuang_2_content">
												<input type="text" id="phone" value="<%=phone %>" style="font-size:25px;" disabled>
											</div>
											
										</div>
									</div>
									<div class="x3">
										<input type="button" style="font-size:25px;" value="update" Onclick="upd(<%=phone%>)"/> 
									</div>
								</div>                  	
                        	</div>
                        </div>
